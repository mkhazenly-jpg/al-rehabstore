...
export const translations = {
  ...
  attritionFilterInactive: 'منتهي الخدمة / المستقيلون',
   ...
   noEmployeesInPeriod: 'لا يوجد موظفون مسجلون خلال هذه الفترة',
    ...
    createdBy: 'بواسطة',
    assignmentDeductionsTab: 'خصومات المهمات',
    assignmentDeductionsPageTitle: 'تفاصيل خصومات المهمات على الموظفين',
    assignmentDeductionsPageDesc: 'كشف بكل الموظفين اللي اتخصمت عليهم قيمة مهمات (شامل الفقدان عند الاستبدال). يمكنك تصفية النتائج وتصديرها إلى Excel، وكذلك تظهر في النسخة الاحتياطية اللي بتروح Drive.',
    deductionType: 'نوع الخصم',
    regularDeduction: 'مهمة غير منتهية',
    lostDeduction: 'فقدان',
    exportSheet: 'تصدير شيت Excel',
    exportAssignmentDeductionsXlsx: 'تصدير خصومات المهمات',
    exportViolationDeductionsXlsx: 'تصدير خصومات المخالفات',
    lostDate: 'تاريخ الفقدان',
    assignmentDeductionsSheetTitle: 'خصومات المهمات',
  },
  en: {
